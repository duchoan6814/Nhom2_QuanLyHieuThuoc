...
public class BanHang extends JFrame {
	...
	public BanHang(String userName) throws IOException {
		...
		pnlRightTop.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0, 0)), "Ch\u1EE9c n\u0103ng",
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				CardLayout cardLayout = (CardLayout) pnlCenter.getLayout();
				cardLayout.show(pnlCenter, "pnlXuatKho");
			}
		});
		...
		pnlRightBottom.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0, 0)), "L\u1EF1a ch\u1ECDn",
